    ...
    ILogger logger) : KcHttpClientBase(logger, baseUrl), IKcRoleMappings
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return ProcessRequestAsync<KcRoleMapping>(
            url,
            HttpMethod.Get,
            accessToken,
    ...
    public Task<KcResponse<object>> AddGroupRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string groupId,
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListGroupRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string groupId,
        CancellationToken cancellationToken = default)
    ...
    public Task<KcResponse<object>> DeleteGroupRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string groupId,
        IEnumerable<KcRole> roles,
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListGroupAvailableRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string groupId,
        CancellationToken cancellationToken = default)
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListGroupEffectiveRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string groupId,
    ...
    public Task<KcResponse<KcRoleMapping>> GetUserRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        CancellationToken cancellationToken = default)
    ...
    public Task<KcResponse<object>> AddUserRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        IEnumerable<KcRole> roles,
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListUserRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        CancellationToken cancellationToken = default)
    ...
    public Task<KcResponse<object>> DeleteUserRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        IEnumerable<KcRole> roles,
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListUserAvailableRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        CancellationToken cancellationToken = default)
    ...
    public Task<KcResponse<IEnumerable<KcRole>>> ListUserEffectiveRealmRoleMappingsAsync(
        string realm,
        string accessToken,
        string userId,
        KcFilter filter = null,
